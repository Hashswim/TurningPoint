...
enum MySpecialColors {
    ...
    static let orderRed     = UIColor(hex: "#FF9B8C")
    static let orderBlue    = UIColor(hex: "#7896FF")
    static let selecteCell  = UIColor(hex: "#d5d5d9")
    static let selecteTxt   = UIColor(hex: "#2b2b2b")
    static let deSelecteTxt = UIColor(hex: "#afb0b5")
    ...
    static let tradingGray = UIColor(red: 255/255, green: 255/255, blue: 255/255, alpha: 0.9)
